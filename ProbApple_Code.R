...
#Functions for the sub model "yield" at four prediction time points
#Yield model tp4####
...
yield_prediction_tp_4_function<-function(fruit_drop_natural_4,
  ...
  mean_fruit_diameter_harvest_p4<-(fruit_diameter_4+
                                     ...
                                     (1-drought_influence)*
                                     (timespan_4/7))
  #fruit weight at harvest calculated based on the diameter
  mean_fruit_volume_harvest_p4<-(4/3)*(mean_fruit_diameter_harvest_p4/2)^3*pi#Assuming an apple has a sherical shape
...
quality_and_yield_p4<-function(){
  #round, because there can't be halve apples
  n_fruits_per_tree_tp4<-round(n_fruits_per_tree_tp4)
  #run the quality function
  quality_prediction<-quality_tp4_function(n_fruits_4=n_fruits_per_tree_tp4,
                                           visibly_damaged_4=percentage_visibly_damaged_tp4,
  ...
  yield_prediction<-yield_prediction_tp_4_function(fruit_drop_natural_4 = pre_harvest_fruit_drop_natural,
                                                   ...
                                                   fruit_diameter_4= fruit_diameter_tp4,
                                                   ...
                                                   trees_per_ha_4=n_trees_per_ha_tp4)
  #qualit yield at harvest
...
#Quality and Yield tp 3####

quality_and_yield_p3<-function(){
  #run the quality model for the time period tp3-tp4
  quality_tp4_p3<-quality_tp3_function(n_fruits_3=round(n_fruits_per_tree_tp3),
                                       visibly_damaged_3=percentage_visibly_damaged_tp3,
  ...
  #run the yield model for the time period tp3-tp4
  yield_tp4_p3<-yield_prediction_tp_3_function(add_fruit_losses_3=quality_tp4_p3$n_falling_hail_tp3_tp4,
    ...
    fruit_diameter_3=fruit_diameter_tp3,
    percentage_tree_losses_3=percentage_tree_losses_tp3_tp4,
    risk_tree_losses_3=risk_tree_losses_tp3_tp4,
    trees_per_ha_3=n_trees_per_ha_tp3)
  #run the quality model for the time period tp4-harvest
  quality_prediction<-quality_tp4_function(n_fruits_4=yield_tp4_p3$number_of_apples_at_tp4_predicted_at_tp3,
                                           ...
                                           damage_fruit_cracking_4=fruit_cracking_damage_tp4_harvest,
                                           add_sunburn_summer_pruning_4=additional_sunburn_summer_pruning_tp4_harvest)
  #run the yield model for the time period tp4-harvest
  yield_prediction<-yield_prediction_tp_4_function(fruit_drop_natural_4 = pre_harvest_fruit_drop_natural,
                                                   fruit_drop_managed_4 = pre_harvest_fruit_drop_spraying,
                                                   storm_risk_4 = risk_of_storm_pre_harvest_tp_4,
                                                   drop_rate_storm_4 = additional_pre_harvest_fruit_drop_storm,
...
quality_and_yield_p2<-function(){
  #run the quality model for the time period tp2-tp3
  quality_tp3_p2<-quality_tp2_function(n_fruits_2=round(n_fruits_per_tree_tp2),
                                       visibly_damaged_2=percentage_visibly_damaged_tp2,
  ...
  #run the yield model for the time period tp2-tp3
  yield_tp3_p2<-yield_prediction_tp_2_function(fruits_per_tree_2= round(n_fruits_per_tree_tp2),
                                               ...
                                               fruit_diameter_2=expected_fruit_diameter_tp2,
                                               ...
                                               trees_per_ha_2=n_trees_per_ha_tp2)
  #run the quality model for the time period tp3-tp4
...
#Quality und Yield tp 1####

quality_and_yield_p1<-function(){
  #run the yield model for the time period tp1-tp2
  yield_tp2_p1<-yield_prediction_tp_1_function(flower_cluster_1=round(n_flower_clusters_tp1),
                                               ...
                                               trees_per_ha_1=n_trees_per_ha_tp1)
  #run the quality model for the time period tp1-tp2
  quality_tp2_p1<-quality_tp1_function(flower_cluster_1=round(n_flower_clusters_tp1),
                                       flowers_per_cluster_1=n_flowers_per_cluster,
